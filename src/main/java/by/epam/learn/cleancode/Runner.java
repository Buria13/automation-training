...
import by.epam.learn.cleancode.aircraft.MilitaryPlane;
import by.epam.learn.cleancode.aircraft.PassengerPlane;
import by.epam.learn.cleancode.aircraft.Plane;
...
public class Runner {
    static List<? extends Plane> planes = Arrays.asList(
